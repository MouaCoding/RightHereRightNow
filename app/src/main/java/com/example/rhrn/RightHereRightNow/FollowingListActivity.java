...
public class FollowingListActivity extends AppCompatActivity {
    ...
    public void getUsersFollowed()
    {
        ...
        userRef.child(key).child("Following").orderByChild("filler").getRef().addChildEventListener(new ChildEventListener() {
            @Override
        ...
        userRef.child(following).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (!dataSnapshot.exists()) return;
                    ...
                    try{
                        userAdapter = new MessageListActivity.UserAdapter(FollowingListActivity.this, userArrayList);
                        userList.setAdapter(userAdapter);
                        userList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            @Override
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                Intent intent = new Intent(FollowingListActivity.this, ViewUserActivity.class);
